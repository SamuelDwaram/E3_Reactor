...
namespace E3Tech.RecipeBuilding.Helpers
{
    ...
    /// an ICommand.
    /// </summary>
    public class GridDropBehaviour
    {
            ...
            DependencyObject inDependencyObject, DependencyPropertyChangedEventArgs inEventArgs)
        {
            ...
            uiElement.Drop += (sender, args) =>
            {
                ...
                GetDropCommand(uiElement).Execute(new GridDropCommandParameters()
                {
    ...
    public class GridDropCommandParameters
    {
