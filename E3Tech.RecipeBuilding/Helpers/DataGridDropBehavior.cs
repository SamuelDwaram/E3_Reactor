...
namespace E3Tech.RecipeBuilding.Helpers
{
    ...
    /// an ICommand.
    /// </summary>
    public class DataGridDropBehavior
    {
            ...
            DependencyObject inDependencyObject, DependencyPropertyChangedEventArgs inEventArgs)
        {
            ...
            uiElement.Drop += (sender, args) =>
            {
                ...
                GetDropCommand(uiElement).Execute(new DataGridDropCommandParameters()
                {
                    DataContext = dataGrid.DataContext,
    ...
    public class DataGridDropCommandParameters
    {
