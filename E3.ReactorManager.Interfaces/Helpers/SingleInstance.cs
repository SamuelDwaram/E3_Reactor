...
namespace SingleInstanceUtilities
{
    public sealed class SingleInstance
    {
        ...
        public void OnWndProc(IntPtr hwnd, int m, IntPtr wParam, IntPtr lParam, bool restorePlacement, bool activate, bool shouldMaximise = false)
        {
            if (m == Message)
            {
                if (restorePlacement)
                {
                    ...
                    if (placement.IsValid && placement.IsMinimized)
                    {
                        /*
                         ...
                         3 -> Open maximised
                         */
                        placement.ShowCmd = shouldMaximise ? 3 : 1;
